...
export const companyKeywordMap: Record<string, string[]> = {
  ...
  "google-deepmind": ["google", "google deepmind", "deepmind", "gemini", "gemini 2.5", "gemini 3", "gemini 3.0", "alphafold"],
  "meta-ai": ["meta", "meta ai", "llama", "llama 4", "llama 5", "executorch", "mtia"],
  xai: ["xai", "x.ai", "grok", "grok 5", "colossus"],
  "microsoft-ai": ["microsoft ai", "copilot", "azure ai", "phi-4", "phi 4", "phi-5", "phi 5"],
  "amazon-aws-ai": ["amazon", "aws", "aws ai", "amazon bedrock", "bedrock", "trainium", "nova", "amazon nova"],

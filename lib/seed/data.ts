...
export const newsItems: NewsItem[] = [
  ...
  {
    slug: "apple-intelligence-foundation-models",
    headline: "Apple publishes research on next-generation Apple Intelligence foundation models",
    sourceName: "Apple ML Research",
    sourceUrl: "https://machinelearning.apple.com",
    publishedAt: "2026-04-03T09:00:00-05:00",
    summary:
      "Apple released a technical report detailing the architecture behind its next round of on-device and server-side foundation models powering Apple Intelligence. The paper emphasizes efficient inference on Apple Silicon and privacy-preserving techniques for cloud-assisted tasks.",
    shortSummary: "Apple opens up on the AI models powering its devices.",
    whyItMatters: "Apple rarely publishes model details. This signals confidence in its approach and a bid for developer credibility.",
    importanceScore: 8,
    importanceLevel: "Critical",
    confidenceScore: 8,
    confidenceLevel: "High",
    impactDirection: "positive",
    companySlugs: ["apple-ai"],
    categorySlugs: ["research"],
    tagSlugs: ["on-device", "enterprise"],
  },
  {
    slug: "hugging-face-open-llm-leaderboard-v3",
    headline: "Hugging Face launches Open LLM Leaderboard v3 with agent-task benchmarks",
    sourceName: "Hugging Face Blog",
    sourceUrl: "https://huggingface.co/blog",
    publishedAt: "2026-04-03T08:30:00-05:00",
    summary:
    ...
    shortSummary: "HF's leaderboard now tests agent skills, not just trivia.",
    whyItMatters: "The most-watched open benchmark just redefined what 'good' looks like for LLMs.",
    importanceScore: 7,
    importanceLevel: "Notable",
    confidenceScore: 8,
    confidenceLevel: "High",
    impactDirection: "positive",
    companySlugs: ["hugging-face"],
    categorySlugs: ["benchmark"],
    tagSlugs: ["benchmarks", "agents", "open-weight"],
  },
  {
    slug: "stability-ai-stable-diffusion-4",
    headline: "Stability AI previews Stable Diffusion 4 with architectural overhaul",
    sourceName: "Stability AI News",
    sourceUrl: "https://stability.ai/news-updates",
    publishedAt: "2026-04-03T07:45:00-05:00",
    summary:
      "Stability AI announced a technical preview of Stable Diffusion 4, featuring a new transformer-based architecture that replaces the U-Net backbone. The company says it delivers sharper detail, better text rendering, and more controllable composition while maintaining open-weight availability.",
    shortSummary: "Stable Diffusion 4 ditches U-Net for transformers.",
    whyItMatters: "The open-weight image generation standard is getting a major architecture upgrade.",
    importanceScore: 7,
    importanceLevel: "Notable",
    confidenceScore: 7,
    confidenceLevel: "Medium",
    impactDirection: "positive",
    companySlugs: ["stability-ai"],
    categorySlugs: ["model-release"],
    tagSlugs: ["image-generation", "open-weight"],
  },
  {
    slug: "cohere-command-a-enterprise-launch",
    headline: "Cohere launches Command A with enterprise RAG optimizations",
    sourceName: "Cohere Blog",
    sourceUrl: "https://cohere.com/blog",
    publishedAt: "2026-04-03T06:30:00-05:00",
    summary:
      "Cohere released Command A, its latest enterprise language model designed for retrieval-augmented generation workflows. The model focuses on grounded answers with citations, reduced hallucination in document-heavy tasks, and deployability across any cloud or on-premises environment.",
    shortSummary: "Cohere's Command A targets the enterprise RAG sweet spot.",
    whyItMatters: "Cohere is carving a clear lane in enterprise AI by prioritizing retrieval accuracy over general chat.",
    importanceScore: 6,
    importanceLevel: "Notable",
    confidenceScore: 7,
    confidenceLevel: "Medium",
  ...
  {
    slug: "together-ai-inference-speed-record",
    headline: "Together AI sets new inference speed record for Llama 4 405B",
    sourceName: "Together AI Blog",
    sourceUrl: "https://www.together.ai/blog",
    publishedAt: "2026-04-02T21:00:00-05:00",
    summary:
    ...
    shortSummary: "Together AI pushes Llama 4 inference past 200 tok/s.",
    whyItMatters: "Speed is becoming the competitive moat for open-model inference platforms.",
    importanceScore: 6,
    importanceLevel: "Notable",
    confidenceScore: 7,
    confidenceLevel: "Medium",
    impactDirection: "positive",
    companySlugs: ["together-ai"],
    categorySlugs: ["infrastructure"],
    tagSlugs: ["open-weight", "api"],
  },
  {
